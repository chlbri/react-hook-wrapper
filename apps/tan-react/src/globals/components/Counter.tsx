...
export const Counter = ({
  ...
  <div className='flex items-center justify-between p-1.5 rounded-xl bg-black/5 dark:bg-white/5 border border-slate-200 dark:border-slate-800  transition-colors duration-500 ease-out'>
    <div className='flex items-center gap-2'>
      <span className='inline-flex items-center justify-center gap-1.5 w-18 py-1 text-xs font-bold rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-400'>
        step: {step}
      </span>
      <SubRenderTracker />
    </div>
