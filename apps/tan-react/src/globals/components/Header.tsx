      ...
      <nav className='max-w-5xl mx-auto w-full flex flex-wrap items-center gap-x-3 gap-y-2 py-3 sm:py-4'>
        ...
        <div className='ml-auto flex items-center gap-1.5 sm:gap-2'>
          <a
            ...
            target='_blank'
            rel='noreferrer'
            className='hidden rounded-xl p-2 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition hover:bg-slate-100 dark:hover:bg-slate-800 sm:block'
          >
